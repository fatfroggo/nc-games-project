...
const seed = async (data) => {
  ...
  CREATE TABLE reviews (
    ...
    designer VARCHAR,
    owner VARCHAR NOT NULL REFERENCES users(username) ON DELETE CASCADE ON UPDATE CASCADE,
  ...
  CREATE TABLE comments (
    ...
    author VARCHAR REFERENCES users(username) ON DELETE CASCADE ON UPDATE CASCADE NOT NULL,
    votes INT DEFAULT 0 NOT NULL,
    created_at TIMESTAMP DEFAULT NOW()
  );`);
